...
1. Add the widget name to `WIDGET_NAMES` in `crates/markdown_to_egui_macro/src/parse.rs`
...
See `examples/third_party_widgets/` for a working example demonstrating the double_slider directive.
