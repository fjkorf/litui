...
pub(crate) struct StyleDef {
    ...
    pub(crate) inner_margin: Option<f32>,
    /// Outer margin in pixels (`Frame::outer_margin`)
    pub(crate) outer_margin: Option<f32>,
...
|--------|-----|-----|-------|------|
| `helpers/lib` | 0 | 5 | 0.17 | foundation |
| `litui/lib` | 2 | 12 | 0.23 | foundation |
| `macro/frontmatter` | 0 | 3 | 0.25 | foundation |
| `snap/lib` | 0 | 3 | 0.25 | foundation |
| `macro/parse` | 1 | 2 | 0.67 | core |
| `macro/lib` | 4 | 4 | 1.00 | core |
...
| `snap/tests/demo_pages` | 3 | 0 | 4.00 | leaf |
| `snap/tests/parent_body` | 3 | 0 | 4.00 | leaf |
| `snap/tests/snapshots` | 3 | 0 | 4.00 | leaf |
