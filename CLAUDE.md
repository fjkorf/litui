...
- **`01_hello`** through **`07_layout`** — Progressive single-page examples using `include_markdown_ui!`
- **`08_multi_page`** — Multi-page app with `define_markdown_app!`, panels, navigation
