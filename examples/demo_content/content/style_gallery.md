...
All styles below are defined in YAML frontmatter and applied with `{key}` references. The macro resolves them at compile time into literal egui `RichText` method chains.
