...
// The macro-generated `Page`/`AppState` are plain types (not Components), so
// they can't implement `Resource` directly. Wrap them in newtypes that derive
// `Resource` (the derive also supplies the required `Component` impl).
