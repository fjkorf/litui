...
#[test]
fn example_md() {
    snapshot_markdown("example_md", include_markdown_ui!("fixtures/example.md"));
}
...
fn headings_only() {
    snapshot_markdown(
        "headings_only",
        include_markdown_ui!("fixtures/headings.md"),
    );
}

#[test]
fn tables() {
    snapshot_markdown("tables", include_markdown_ui!("fixtures/tables.md"));
}

#[test]
fn styled() {
    snapshot_markdown("styled", include_markdown_ui!("fixtures/styled.md"));
}

#[test]
fn widgets() {
    snapshot_markdown("widgets", include_markdown_ui!("fixtures/widgets.md"));
}

#[test]
fn selectors() {
    snapshot_markdown("selectors", include_markdown_ui!("fixtures/selectors.md"));
}
...
fn inline_styles() {
    snapshot_markdown(
        "inline_styles",
        include_markdown_ui!("fixtures/inline_styles.md"),
    );
}
...
fn widgets_in_table() {
    snapshot_markdown(
        "widgets_in_table",
        include_markdown_ui!("fixtures/widgets_in_table.md"),
    );
}
...
#[test]
fn stateful_button() {
    let (render, mut state) = include_markdown_ui!("fixtures/stateful_button.md");
    let width = 800.0;
    let mut harness = Harness::builder()
        .with_size(egui::vec2(width, 600.0))
        .with_max_steps(16)
...
#[test]
fn image() {
    let render = include_markdown_ui!("fixtures/image.md");
    let width = 800.0;
...
#[test]
fn advanced_button() {
    let (render, mut state) = include_markdown_ui!("fixtures/advanced_button.md");
    let width = 800.0;
    let mut harness = Harness::builder()
        .with_size(egui::vec2(width, 600.0))
        .with_max_steps(16)
...
#[test]
fn new_widgets() {
    let (render, mut state) = include_markdown_ui!("fixtures/new_widgets.md");
    let width = 800.0;
    let mut harness = Harness::builder()
        .with_size(egui::vec2(width, 600.0))
        .with_max_steps(16)
...
#[test]
fn new_tier_widgets() {
    let (render, mut state) = include_markdown_ui!("fixtures/new_tier_widgets.md");
    let width = 800.0;
    let mut harness = Harness::builder()
        .with_size(egui::vec2(width, 600.0))
        .with_max_steps(16)
...
#[test]
fn display_only() {
    let (render, mut state) = include_markdown_ui!("fixtures/display_only.md");
...
#[test]
fn select_widget() {
    let (render, mut state) = include_markdown_ui!("fixtures/select_widget.md");
...
#[test]
fn foreach_table() {
    let (render, mut state) = include_markdown_ui!("fixtures/foreach_table.md");
...
fn stateful_progress() {
    let (render, mut state) = include_markdown_ui!("fixtures/stateful_progress.md");
    state.hp_frac = 0.65;
    state.mp_frac = 0.3;
    state.xp_frac = 0.8;
    let width = 800.0;
...
#[test]
fn log_widget() {
    let (render, mut state) = include_markdown_ui!("fixtures/log_widget.md");
    state.messages = vec![
...
#[test]
fn if_block_true() {
    let (render, mut state) = include_markdown_ui!("fixtures/if_block.md");
    state.has_orb = true;
    let width = 800.0;
    let mut harness = Harness::builder()
        .with_size(egui::vec2(width, 600.0))
...
#[test]
fn style_block() {
    let (render, mut state) = include_markdown_ui!("fixtures/style_block.md");
...
fn frame_style() {
    snapshot_markdown(
        "frame_style",
        include_markdown_ui!("fixtures/frame_style.md"),
    );
}
